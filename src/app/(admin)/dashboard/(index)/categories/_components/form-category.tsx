...
import { useRouter } from "next/navigation"; // Pastikan Anda menggunakan import ini
...
export default function FormCategory({
	...
	// Tambahkan handler untuk tombol Discard
	const handleDiscard = (event: React.MouseEvent) => {
		event.preventDefault(); // Mencegah pengiriman form
		router.push("/dashboard/categories"); // Navigasi kembali ke halaman kategori
	};

	// Fungsi untuk mencegah submit saat menekan Enter
	const handleKeyDown = (event: React.KeyboardEvent<HTMLFormElement>) => {
		if (event.key === "Enter") {
			event.preventDefault(); // Mencegah aksi default untuk tombol Enter
		}
	};
